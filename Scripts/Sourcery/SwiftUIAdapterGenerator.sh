...
TEMPLATE_PATH="$PROJECT_ROOT/Scripts/Sourcery/SwiftUIAdapter.stencil"
...
echo "Cleaning up previous SwiftUIAdapter files..."
find "$OUTPUT_DIR" -name '*SwiftUIAdapter.swift' -type f -delete
