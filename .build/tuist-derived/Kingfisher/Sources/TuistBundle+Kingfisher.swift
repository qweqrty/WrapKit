...
/// Since Kingfisher is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Kingfisher_Kingfisher"
    ...
    fatalError("unable to find bundle named Kingfisher_Kingfisher")
}()
}
