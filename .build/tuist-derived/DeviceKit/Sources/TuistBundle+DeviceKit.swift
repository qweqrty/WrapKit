...
/// Since DeviceKit is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "DeviceKit_DeviceKit"
    ...
    fatalError("unable to find bundle named DeviceKit_DeviceKit")
}()
}
