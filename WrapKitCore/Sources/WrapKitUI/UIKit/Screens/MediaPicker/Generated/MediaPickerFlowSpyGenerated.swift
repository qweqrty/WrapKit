...
public class MediaPickerFlowSpy<View: Any>: MediaPickerFlow {

    public init() {}

    public enum Message: HashableWithReflection {
        case showMediaPickerSourceTypes(sourceTypes: [MediaPickerSource<View>], localizable: MediaPickerLocalizable, callback: ((MediaPickerResultType?) -> Void)?)
        case finish
    }
    ...
    public private(set) var capturedShowMediaPickerSourceTypes: [(sourceTypes: [MediaPickerSource<View>], localizable: MediaPickerLocalizable, callback: ((MediaPickerResultType?) -> Void)?)] = []
