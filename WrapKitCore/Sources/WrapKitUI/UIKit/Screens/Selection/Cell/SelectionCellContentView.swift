...
public class SelectionCellContentView: ViewUIKit {
    ...
    public let leadingImageContainerView = ViewUIKit(isHidden: true)
    public let leadingImageView = ImageView()
    public let trailingImageContainerView = ViewUIKit(isHidden: true)
    public let trailingImageView = ImageView()
    public let leadingStackView = StackView(axis: .horizontal, spacing: 8)
    public let lineView = ViewUIKit(backgroundColor: .gray)
