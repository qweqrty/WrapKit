...
open class BottomSheetController<View: UIView>: ViewController<View> {
    ...
    open var preferredSheetCornerRadius: CGFloat = isAvailableOS26 && isLiquidGlassEnabled ? 32 : 12 {
        didSet {
    ...
    open var onTapOutside: (() -> Void)? {
        didSet {
            bottomSheetTransitioningDelegate.onTapOutside = onTapOutside
        }
    }

    open var onPanToDismiss: (() -> Void)? {
        didSet {
