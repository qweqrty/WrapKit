...
public final class ImageViewOutputSpy: ImageViewOutput {
    ...
    public private(set) var capturedDisplayModelCompletion: [(ImageViewPresentableModel?, ((Image?) -> Void)?)] = []
    public private(set) var capturedDisplayImageCompletion: [(ImageEnum?, ((Image?) -> Void)?)] = []
