...
open class CollectionViewCell<ContentView: UIView>: UICollectionViewCell {
    ...
    open override func hitTest(_ point: CGPoint, with event: UIEvent?) -> UIView? {
        ...
        if let mainPressableView = (mainContentView as? ViewUIKit),
    ...
    private func checkForPressableView(in view: UIView, at point: CGPoint) -> UIView? {
        ...
        if let pressableView = view as? ViewUIKit, pressableView.onPress != nil, pressableView.point(inside: convertedPoint, with: nil) {
